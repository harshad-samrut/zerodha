...
import "./ChargesExplain.css";

function ChargesExplain() {
  return (
    <section className="container my-5 charges">
      <div className="row justify-content-center">
        <div className="col-12 col-lg-10">
          <h4 className="fw-medium text-dark mb-4">Charges explained</h4>

          {/* Two-Column Stacked Grid */}
          <div className="row gy-4 gx-lg-5">
            ...
            <div className="col-12 col-md-6">
              ...
              <p>
                ...
                than ₹4,00,000. To learn more about BSDA, <a href="#" className="link">Click here</a>
              </p>
              <p>
                For non-BSDA demat accounts: ₹300/year + 18% GST charged quarterly
                (90 days). To learn more about AMC, <a href="#" className="link">Click here</a>
              </p>
              ...
              <p>
                ...
                balance in your trading account. <a href="#" className="link">Learn more</a>.
              </p>
          ...
          <div className="row mt-5">
            <div className="col-12">
              <h5 className="fw-medium">Disclaimer</h5>
